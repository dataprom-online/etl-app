...
internal static class ETLPipeline
{
    ...
    public static void GenerateAndUploadDummyData(bool deletePreviousDb = true)
    {
        ...
        ConsolePrint.WriteLine("Download + Upload DUMMY data...", ConsolePrint.Category.Progress);
    ...
    public static IEnumerable<DynamicRecordStruct> Extract()
    {
        ...
        ConsolePrint.WriteLine("Download data from local db..", ConsolePrint.Category.Progress);
